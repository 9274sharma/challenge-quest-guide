      ...
      <div className={`flex-1 ${isAnimating ? 'animate-fade-out' : 'animate-fade-in-up'}`}>
        <div className="text-center mb-8">
          ...
          <p className="text-foreground-secondary">
            How tough do you want your challenges to be? You can always change this later.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${difficulty.color} flex items-center justify-center flex-shrink-0`}>
                    <Icon className="w-6 h-6 text-white" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <h3 className="font-semibold text-foreground">{difficulty.label}</h3>
