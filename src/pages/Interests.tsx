...
export const Interests = () => {
  ...
  const handleContinue = () => {
    ...
    setIsAnimating(true);
    setTimeout(() => {
      navigate("/motivation"); // Go to new Motivation screen
    }, 300);
  };
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          {interests.map((interest) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 mx-auto mb-3 rounded-2xl bg-gradient-to-br ${interest.color} flex items-center justify-center`}
                >
